...
duplicate = (arr) => {
    ...
    for(let i = 0; i < arr.length; i++){
        ...
        mainComment.innerText = arr[i].comment;
...
displayComment = event => {
    ...
    axios.post(bandsiteAPI+postEndpoint+commentEndpoint+keyApi, {name:textName,timestamp: `${month}/${date}/${year}`,comment: textComment,})
    .then(response => {
